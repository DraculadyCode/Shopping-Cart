  ...
  return (
    <>
      ...
      <p className="fs-4">
        ...
        <a
          href="https://www.kathrinpeled.de"
          target="_blank"
        ...
        and{" "}
        <a
          href="https://onid89.github.io/Web-Dev-Portfolio/"
          target="_blank"
          rel="noopener noreferrer"
        >
          Gerardo Mussuto
        </a>{" "}
        as a virtual shop in order to improve our skills in the Ecommerce field.
        We are expecting to create bigger and meaningful projects in the near
        future. We are inviting you to look at our portfolios and see our skills
        and new projects{" "}
        <svg
